...
public class HeroDetailPresenterImp implements  OnApiCalledFinished{

    private OnApiCalledFinished onApiCalledFinished;
    private HeroesListViewInterface heroesListViewInterface;

    public HeroDetailPresenterImp() {

        onApiCalledFinished = this;
    }

    public HeroDetailPresenterImp(HeroesListViewInterface heroesListViewInterface) {
